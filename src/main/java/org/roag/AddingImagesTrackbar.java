...
/**
 * Copy-past from https://docs.opencv.org/master/da/d6a/tutorial_trackbar.html
 */
public class AddingImagesTrackbar {
    ...
    public AddingImagesTrackbar(String[] args) {
        String imagePath1 = "src/main/resources/guardians.jpg";
        String imagePath2 = "src/main/resources/guardians_upsidedown.jpg";
        if (args.length > 1) {
            imagePath1 = args[0];
            imagePath2 = args[1];
        }
